                    ...
                    <div class="relative" id="user-menu">
                        ...
                        <div id="user-menu-panel" class="absolute right-0 top-full mt-2 w-52 bg-white border border-outline-variant rounded-xl shadow-lg z-50 overflow-hidden opacity-0 translate-y-2 pointer-events-none transition-all duration-150">
                            ...
                            @if($user?->isAffiliator())
                                ...
                                <a href="{{ route('account.crm') }}" class="flex items-center gap-3 px-4 py-3 text-sm {{ request()->routeIs('account.crm') ? 'text-primary font-bold bg-primary/5' : 'text-on-surface hover:bg-surface-container-low' }} transition-colors">
                                    <span class="material-symbols-outlined text-xl text-on-surface-variant">monitoring</span> CRM
                                </a>
