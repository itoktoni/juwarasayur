<?php /** @var Modules\Catalog\Models\Category $table */ ?>

<x-layouts::app>
    <x-breadcrumb :items="[['url' => '/dashboard', 'label' => 'Home'], ['url' => '', 'label' => 'Kategori Produk']]" />
        ...
        <x-table>
            ...
            <x-slot:body>
                ...
                <tr>
                    ...
                    <td>{{ $table->category_slug }}</td>
                    <td>{{ $table->has_parent->category_nama ?? '-' }}</td>
                    ...
                    <x-table-mobile-item :id="$table->field_primary">
                        ...
                        <div class="mt-2 space-y-1.5">
                            <div class="flex justify-between items-center gap-2">
                                ...
                                <span class="text-sm font-medium text-right">{{ $table->category_slug }}</span>
                            </div>
                            <div class="flex justify-between items-center gap-2">
                                <span class="text-xs text-on-surface-variant">Parent</span>
                                <span class="text-sm font-medium text-right">{{ $table->has_parent->category_nama ?? '-' }}</span>
                            </div>
                        </div>
