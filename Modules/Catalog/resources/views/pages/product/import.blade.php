    ...
    <div class="content mt-4 lg:mt-0">
        ...
        <x-card label="Upload & Import" icon="upload" :noGrid="true" class="mt-5">
            ...
            <p class="text-xs text-on-surface-variant mb-2">
                Format: <code class="bg-surface-container px-1 py-0.5 rounded">Nama Produk;Nama Grosir;Kode Produk;Harga Jual;Harga Grosir;Is Grosir;Harga Modal;Stok;Fee Affilator (%);Sort Order;Flag</code> (delimiter <code>;</code> sesuai <code>config/website.php</code>)
            </p>
